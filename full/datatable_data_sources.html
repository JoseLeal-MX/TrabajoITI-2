				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							...
							<div class="media-body">
								<div class="media-title font-weight-semibold">José Leal</div>
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables">
								...
								<li class="nav-item"><a href="datatable_data_sources.html" class="nav-link active">Vacaciones</a></li>
							</ul>
						</li>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Empleados - Vacaciones</h5>
					...
					<div class="card-body">
						En este apartado, usted puede asignar un determinado tiempo de vacaciones a determinado empleado que se lo pida. Llene este pequeño formulario con los datos que se le piden.
					</div>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							<tr>
								...
								<td>30</td>
								<td>22-Junio-1989</td>
								<td>Ciruelo, #1892, Fracc. El Olivo</td>
								<td>834-123-3321</td>
								<td>mlopez_89@outlook.com</td>
								<td>$1,500</td>
							...
							<tr>
								...
								<td>Carrera</td>
								<td>29</a></td>
								<td>3-Octubre-1989</td>
								<td>Artículo 29, #1010, Casas Blancas</td>
								<td>834-512-2002</td>
								<td>Pendiente</td>
								<td>$2,000</td>
								<td class="text-center">
							...
							<tr>
								...
								<td>47</td>
								<td>19-Abril-1972</td>
								<td>Amp. Linda Vista, #449, Mainero</td>
								<td>834-221-2918</td>
								<td>acruzdl@gmail.com</td>
								<td>$2,000</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
							...
							<tr>
								...
								<td>Requena</td>
								<td>42</a></td>
								<td>13-Diciembre-1977</td>
								<td>Horacio Terán, #621, Vamos Tamaulipas</td>
								<td>834-212-4152</td>
								<td>Pendiente</td>
								<td>$1,500</td>
								<td class="text-center">
							...
							<tr>
								...
								<td>Aguilar</td>
								<td>28</a></td>
								<td>30-Diciembre-1991</td>
								<td>Artículo 123, #110, Amalia G. de Castillo Ledón</td>
								<td>834-222-2010</td>
								<td>sharon_aguilar@outlook.com</td>
								<td>$900</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
							...
							<tr>
								...
								<td>López</td>
								<td>32</a></td>
								<td>17-Octubre-1987</td>
								<td>Bénito Juárez, #150, Praxedis Balboa</td>
								<td>834-112-1122</td>
								<td>N/P (no proporcionado)</td>
								<td>$750</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
							...
							<tr>
								...
								<td>Martinez</a></td>
								<td>36</td>
								<td>11-Noviembre-1983</td>
								<td>Ravizé, #3350, Casas Blancas</td>
								<td>833-122-1120</td>
								<td>Sin correo</td>
								<td>$1,750</td>
								<td class="text-center">
							...
							<tr>
								...
								<td>Amairani</a></td>
								<td>58</td>
								<td>1-Noviembre-1961</td>
								<td>La Moderna, #1200, Fracc. Los Olivos</td>
								<td>833-112-2331</td>
								<td>lamairani58@hotmail.com</td>
								<td>$1,750</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
							...
							<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="ej. José Ramón Fernandez">
									</div>
							</div>
							...
							<div class="form-group row">
									<label class="col-form-label col-lg-2">Fin de vacaciones</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
							</div>
							...
							<div class="form-group row">
									<label class="col-form-label col-lg-2">Prima vacacional</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="La prima vacacional se calcula multiplicando el salario del empleado por los días de vacaciones, y ese resultado se multiplica por 0.25.">
									</div>
							</div>
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
		                    	<button type="button" class="btn btn-danger rounded-round">Vaciar</button>
							</div>
						</div>
					</div>
