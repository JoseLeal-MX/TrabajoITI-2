			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Base de datos</span> - Departamentos</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Departamentos de la empresa</h5>
					...
					<div class="card-body">
						En esta lista, se muestra de manera detallada los distintos departamentos de la empresa, desde su ubicación y su especialidad hasta el nombre por el que se le identifica en la empresa. 
					</div>
