			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Inicio</span> - Realizando reparaciones</h4>
								...
								<div class="row">
									<div class="col-sm-4">
										<div class="d-flex align-items-center justify-content-center mb-2">
											...
											<div>
												<div class="font-weight-semibold">Población México</div>
												<span class="text-muted">128,349,500 avg</span>
											</div>
										</div>
										<div class="w-75 mx-auto mb-3" id="new-visitors"></div>
									</div>
									...
									<div class="col-sm-4">
										<div class="d-flex align-items-center justify-content-center mb-2">
											...
											<div>
												<div class="font-weight-semibold">Precio petróleo Ecuador</div>
												<span class="text-muted">Sin valor fijo, subiendo y bajando</span>
											</div>
										</div>
										<div class="w-75 mx-auto mb-3" id="new-sessions"></div>
									</div>
									...
									<div class="col-sm-4">
										<div class="d-flex align-items-center justify-content-center mb-2">
											...
											<div>
												<div class="font-weight-semibold">Apoyo a Trump</div>
												<span class="text-muted"><span class="badge badge-mark border-success mr-2"></span> 500,378 ciudadanos</span>
											</div>
										</div>
										<div class="w-75 mx-auto mb-3" id="total-online"></div>
									</div>
