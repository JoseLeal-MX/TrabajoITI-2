		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Tabla</span> - Alumnos</h4>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						Bienvenido al apartado de Alumnos, otra sección demasiado alejada de lo que se está tratando en esta empresa. Aquí puede dar un vistazo a los alumnos registrados.
					</div>
					...
					<table class="table datatable-header-basic">
						<thead>
							<tr>
								...
								<th>Matrícula</th>
								<th>Carrera</th>
								<th>E-mail (Personal o Institucional)</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td>18</td>
								<td>1930669</td>
								<td>Ingeniería a las Tecnologías de la Información</td>
								<td>jsjose219@gmail.com</td>
							...
							<tr>
								...
								<td>1920129</td>
								<td>Mecatrónica</td>
								<td>sgarcia_requena@outlook.com</td>
								<!--td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
							...
							<tr>
								...
								<td>esanchezperu@outlook.com</td>
								<!--td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
