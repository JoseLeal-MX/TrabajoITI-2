			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Tabla</span> - Borrar empresas</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Borrar empresas</h5>
					...
					<div class="card-body">
						Si una empresa se declara en <code>quiebra, </code>se considera como "ineficaz" para seguir manteniendo relaciones con la misma, por lo que una buena opción sería borrarla del listado de empresas. Identifique la empresa que no le sea util, y borrela.
					</div>
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
		                    	<button type="button" class="btn btn-primary">Borrar empresa</button>
	                    	</div>
						</div>
					</div>
				<!-- /horizontal borders -->
