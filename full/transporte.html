					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								<li class="nav-item"><a href="table_basic2.html" class="nav-link">Lista de empresas</a></li>
								<li class="nav-item"><a href="table_sizing2.html" class="nav-link">Actualizar datos de empresa</a></li>
								<li class="nav-item"><a href="table_borders2.html" class="nav-link">Eliminar empresas</a></li>
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<li class="nav-item"><a href="transporte.html" class="nav-link">Pago de transporte escolar</a></li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-grid7"></i> <span>EMPLEADOS</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Data tables">
								<li class="nav-item"><a href="datatable_basic2.html" class="nav-link">Lista de empleados</a></li>
								<li class="nav-item"><a href="datatable_styling2.html" class="nav-link">Actualizar lista de empleados</a></li>
								<li class="nav-item"><a href="datatable_advanced2.html" class="nav-link">Agregar empleados</a></li>
                        ...
                        <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables">
								<li class="nav-item"><a href="datatable_api2.html" class="nav-link active">Departamentos</a></li>
								<li class="nav-item"><a href="datatable_responsive2.html" class="nav-link">Actualizar lista de apartamentos</a></li>
								<li class="nav-item"><a href="datatable_sorting2.html" class="nav-link">Agregar departamentos</a></li>
						<!--li class="nav-item nav-item-submenu">
