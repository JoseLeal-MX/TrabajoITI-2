			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Agregar empleados</h5>
					...
					<div class="card-body">
						Bienvenido al registro de empleados, donde solo hace falta que recuerde bien los datos de sus empleados para registrarlos en la <code>base de datos</code> de la empresa. Por favor, llene los campos que se le indican. 
					</div>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							...
							<div class="form-group row">
									<label class="col-form-label col-lg-2">Domicilio</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
							</div>
