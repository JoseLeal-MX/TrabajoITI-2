			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Empleados</span> - Actualizar datos</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Actualizar datos de empleados</h5>
					...
					<div class="card-body">
						Usted dispone de este espacio para actualizar o corregir algún dato de los empleados que trabajen en esta empresa, ya sea para corregir datos ingresados por error o para actualizar un dato en específico de un empleado.
					</div>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							...
							<div class="form-group row">
									<label class="col-form-label col-lg-2">Fecha de nacimiento</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
							</div>
